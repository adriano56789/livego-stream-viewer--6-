...
import { CameraIcon, MicrophoneIcon, CloseIcon } from './icons';
...
const CameraPermissionModal: React.FC<CameraPermissionModalProps> = ({ isOpen, permissionType, onAllowAlways, onAllowOnce, onDeny, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-[#2c2c2e] rounded-t-2xl p-6 w-full max-w-md text-center text-white transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-y-0' : 'translate-y-full'} relative`}
